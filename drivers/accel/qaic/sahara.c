 ...
 * no deadspace inbetween. Userspace can use the sizes listed in the image table
 * to reconstruct the individual images.
 */
...
static void sahara_dump_processing(struct work_struct *work)
{
	 ...
	 * it is suposed to send EOI with an error code.
	 */
