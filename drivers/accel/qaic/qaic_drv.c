...
#define PCI_DEVICE_ID_QCOM_AIC200PF	0xa110
...
struct qaic_device_config {
	/* Number of DBCs the device exposes */
	u32 dbc_count;
...
static const struct qaic_device_config aic100_config = {
	.dbc_count = AIC100_DBC_COUNT,
	.bar_mask = BIT(0) | BIT(2) | BIT(4),
	.mhi_bar_idx = 0,
	.dbc_bar_idx = 2,
};

static const struct qaic_device_config aic200pf_config = {
	.dbc_count = AIC200PF_DBC_COUNT,
...
static const struct pci_device_id qaic_ids[] = {
	...
	{ PCI_DEVICE_DATA(QCOM, AIC200PF, (kernel_ulong_t)&aic200pf_config), },
